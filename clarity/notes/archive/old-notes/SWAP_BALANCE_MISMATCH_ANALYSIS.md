...
3. Does the contract return the actual amount swapped (which we should use for validation)?
4. Are there any error codes for "insufficient liquidity" that should be returned instead?
